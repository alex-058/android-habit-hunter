...
public final class FragmentStatsBinding implements ViewBinding {
  ...
  private FragmentStatsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textHome) {
  ...
  public static FragmentStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStatsBinding((ConstraintLayout) rootView, textHome);
    }
